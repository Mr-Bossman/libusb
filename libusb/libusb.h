...
void LIBUSB_CALL libusb_free_platform_descriptor(
	struct libusb_platform_descriptor *platform_descriptor);
int LIBUSB_CALL libusb_get_blockdev_path(libusb_device *dev, char *path, size_t path_length);
int LIBUSB_CALL libusb_get_chardev_path(libusb_device *dev, char *path, size_t path_length);
